...
<div id="neoeinrichtungstermine_menue">
	<div style="float:left; width: 20%">
		<a href="?cid=<?= $this->flash->instid ?>&day=<?= $_REQUEST["day"]-7 ?><? if(isset( $_REQUEST["datum"])) : ?>&datum=<?= $_REQUEST["datum"] ?><? ENDIF ?>"> <img src="/assets/images/icons/16/yellow/arr_2left.png"></a>
	</div>
	...
	<div style="float:right; width: 20%">
		<a href="?cid=<?= $this->flash->instid ?>&day=<?= $_REQUEST["day"]+7 ?><? if(isset( $_REQUEST["datum"])) : ?>&datum=<?= $_REQUEST["datum"] ?><? ENDIF ?>"><img src="/assets/images/icons/16/yellow/arr_2right.png" style="float: right"></a>
	</div>
</div>
